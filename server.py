...
def perguntar(body: PerguntaRequest, x_api_key: str | None = Header(default=None)):
    ...
    prompt = f"Resolva a questão como se fosse um inciante mas com certeza nao precisa explicar bote algums comentarios se quiser nao exagere nos comentarios estilo humano no codigo e se a questao pedir restrição tipo não pode usar def voce vai seguir a restrição ao todo custo: {pergunta}"
